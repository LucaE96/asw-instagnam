...
bash "$DIR"/connessioni/build-database-image-and-volume.sh && 
bash "$DIR"/connessioni/build-service-image.sh &&
bash "$DIR"/ricette/build-database-image-and-volume.sh && 
bash "$DIR"/ricette/build-service-image.sh
bash "$DIR"/ricette-seguite/build-database-image-and-volume.sh && 
